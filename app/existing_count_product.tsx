    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.description}>
          You have an existing product batch.{"\n"}
...
export default ExistingCountProduct;
