    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          <Text style={styles.title}>Multi-Item Batch Picking</Text>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.description}>
          Select quantity of totes and start picking!
        </Text>

        <View style={styles.toggleRow}>
          <Text style={styles.toggleText}>Exclude Single Line Orders</Text>
          <ToggleSwitch
            isOn={excludeSingleLine}
            onColor="black"
            offColor="lightgrey"
            size="medium"
            trackOnStyle={styles.toggleTrackOn}
            trackOffStyle={styles.toggleTrackOff}
            thumbOnStyle={styles.toggleOnThumb}
            thumbOffStyle={styles.toggleOffThumb}
            onToggle={(isOn) => setExcludeSingleLine(isOn)}
          />
        </View>

        <View style={styles.toggleRow}>
          <Text style={styles.toggleText}>Pick by Tag</Text>
          <ToggleSwitch
            isOn={pickByTag}
            onColor="black"
            offColor="lightgrey"
            ...
            thumbOnStyle={styles.toggleOnThumb}
            thumbOffStyle={styles.toggleOffThumb}
            onToggle={(isOn) => setPickByTag(isOn)}
          />
        </View>
      </View>
...
export default MultiItemBatchPicking;
