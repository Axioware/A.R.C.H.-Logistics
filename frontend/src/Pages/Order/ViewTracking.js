  ...
  return (
    <div>
      ...
      <div style={styles.mainContent}>
        <NavPath
          text={["Home", "Orders", "View Trackings"]}
          paths={["/home", "/orders", "/view-tracking"]}
          text_color={[255, 255, 255]}
        ...
        <div style={styles.lightGreyBackground}>
          ...
          <TableTop 
          heading_text={'View Trackings'} 
          />

          <TableContent
            table_headings={['LLC Name', 'Number of Boxes/Pallets', "Date Received", "Action"]}
            last_column={true}
            loading={loading}
            success={success}
