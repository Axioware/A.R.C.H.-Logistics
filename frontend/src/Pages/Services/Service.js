...
import FilterOptionsUser from '../../Components/Filter/FilterOptionUserManagement';
    ...
    <>
      <div>
        ...
        <div style={mainStyles.centerContent(isSidebarClosed)}>
          <NavPath text={["Home", "Service"]} paths={["/home", "/service"]} />
          <AddButton text="Add Service" path='/add-service' />
          <div style={mainStyles.tableBackground}>
            <div style={mainStyles.tableTopContainer}>
              <PageHeading text={'Services'} width="auto" />
            ...
            <div style={{ overflowX: "auto", width: "100%" }}>
              <div style={{ minWidth: "1500px" }}>
                <TableContent
                  table_headings={['Service ID', 'Service Name', 'Category', 'Default Charges', '']}
                  last_column={true}
                  loading={loading}
                  success={success}
